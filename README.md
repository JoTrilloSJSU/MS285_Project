...
This Github contains all the necessary files to run a sealion foraging videogame based on results of Fiechter et al. 2016. Paper is included in Github files.
...
Sardines restore fat deposits (health bar) more than than anvhovies to reflect higher energy density.

Fat depositsare depleted by movement and increased by fish consumption.
